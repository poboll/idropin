    ...
    <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-4 mb-4">
      ...
      {actions.length === 0 ? (
        <div className="empty-state py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-2">暂无提交历史</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400">下载和归档操作将显示在这里</p>
        </div>
      ) : (
        <>
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="border-b dark:border-gray-700">
                  ...
                  <th className="text-left py-2 px-3 font-medium text-gray-600 dark:text-gray-400">文件信息</th>
                  <th className="text-left py-2 px-3 font-medium text-gray-600 dark:text-gray-400">任务类型</th>
